        ...
        try:
            ...
            while True:
                params = {
                    "limit": 200,
                    "offset": offset,
                    "ad_plan_id": campaign_id,   # <-- поле из документации
            ...
            # 2️⃣ Для каждой группы получаем активные баннеры
            ...
            for g in ad_groups:
                ...
                while True:
                    params_b = {
                        ...
                        "offset": offset_b,
                        "ad_group_id": gid,
                        "_status": "active",  # <-- только активные
                    }
            ...
            logger.info(f"Кампания {campaign_id}: добавлено баннеров в исключения {len(seen)}")
