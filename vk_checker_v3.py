...
ACCOUNTS: List[AccountConfig] = [
    ...
    AccountConfig(
        user_json_path="/opt/vk_checker/data/users/393602736.json",
        name="Вадим 7007",
        check_all_camp=True,
    ...
    AccountConfig(
        user_json_path="/opt/vk_checker/data/users/1550242935.json",
        name="Евгений Зеленов zk 5005 3",
        check_all_camp=True,
        income_json_path="/opt/leads_postback/data/krolik.json",
        spent_all_time_dont_touch=1000,
        allowed_banners=[],
    ...
    AccountConfig(
        user_json_path="/opt/vk_checker/data/users/1550242935.json",
        name="Евгений Зеленов zk 5005 2",
        check_all_camp=True,
        income_json_path="/opt/leads_postback/data/krolik.json",
        spent_all_time_dont_touch=700,
        allowed_banners=[],
    ...
    AccountConfig(
        user_json_path="/opt/vk_checker/data/users/1170798256.json",
        name="Гузель Мазитова zk 5005 1",
        check_all_camp=True,
        spent_all_time_dont_touch=1000,
        income_json_path="/opt/leads_postback/data/insta.json",
        allowed_banners=[],
